...
<section class="hero">
    <div class="container hero-content">
        ...
        <div class="hero-buttons">
            <a href="{{ route('courses') }}" class="btn btn-primary">Mulai Belajar</a>
            <a href="{{ route('faq') }}" class="btn btn-secondary">Pelajari Lebih Lanjut</a>
        </div>
    </div>
</section>
                ...
                <section class="books-section">
                    <div class="container">
                        ...
                        <div class="books-grid">
                            ...
                            <div class="book-card">
                                <div class="book-img">
                                    <img src="{{ asset('images/book-placeholder.jpg') }}" alt="{{ $book->title }}">
                                </div>
