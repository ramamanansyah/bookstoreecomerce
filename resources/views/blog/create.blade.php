...
<div class="container">
    <div class="blog-form-container">
        <h1 class="form-title">Tambah Post Baru</h1>
        ...
        <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" name="excerpt" rows="4" required class="form-control">{{ old('excerpt') }}</textarea>
                @error('excerpt')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" rows="15" required class="form-control ckeditor">{{ old('content') }}</textarea>
                @error('content')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
...
<div class="form-group-half">
    ...
    @enderror
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-large">Simpan Post</button>
